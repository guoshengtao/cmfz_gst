    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                <li><a href="#">欢迎:${admin1.nickname}</a></li>
                <li><a href="${pageContext.request.contextPath}/login/login.jsp">退出登录</a></li>
            </ul>
        </div><!-- /.navbar-collapse -->
    </div><!-- /.container-fluid -->
</nav>
...
<div class="row">
        ...
        <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
            ...
            <div class="panel panel-default">
                ...
                <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
                    <div class="panel-body text-center">
                        <a href="javascript:$('#content-layout').load('user/user-show.jsp')" class="btn btn-default">所有用户</a>
                        <br>
                        <br>
                        <a href="javascript:$('#content-layout').load('user/user-show.jsp')" class="btn btn-default">用户数据</a>
                    </div>
    ...
    <div class="col-sm-10" id="content-layout">
        ...
        <img src="img/95c8d82ajw1f8wp86yq18j21hc0u0q9z.jpg" alt="" style="width: 100%;">
    </div>
</div>
